...
When your dependences have been installed, at the command prompt <cd>cd frontend</code> to get to the frontend folder and run <code>npm start</code>. If your browswer window doesn't automatically open to <a href="localhost:3000/">localhost:3000/</a>, click the link to open a new window. 
